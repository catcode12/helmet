...
uniform vec3 gravityDirections;
...
void main () {
    ...
    vec3 newVelocity = velocity + vec3(gravityDirections.x * u_timeStep, gravityDirections.y * u_timeStep, gravityDirections.z * u_timeStep); //add gravity
